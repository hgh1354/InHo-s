  ...
  <section id="container">
    ...
    <section id="main-content" style="min-height:800px;">
	  <section class="wrapper">
        <h3><a href="purchase_form.php"><i class="fa fa-angle-right"></i><?if(isset($no)){echo '매입 상세';}else{echo '매입 등록';}?></a></h3>
			...
			<?if(isset($no)){echo '
				 ...
				 <input type="hidden" name="in_out_cate" value="매입">
		...
		<div class="row mt">
          ...
          <div class="col-lg-12" style="">
						...
						<div class="row" >
						  <div class="col-lg-2" style="float:right" >
							<table class="table table-bordered table-hover table-striped"  >
							  <tr style="table align:right">
								<td class="numeric" data-title="" style="text-align:center">합계 금액</td>
								<td class="numeric" data-title="합계 금액"><input type="text" id="total_price"  name="total_price" value =""readonly></td>
							  <tr>
							</table>
						  </div>
						</div>
			...
			<div class="row mt" style="text-align:right">
				<div class="col-lg-12">
					<a href="#" data-toggle="modal" data-target="#Modal_order"><button class="btn btn-theme02" type="button">발주서 불러오기</button></a>
					<button class="btn btn-theme" id="sub" type="submit" onmousemove="sumPrice()" ><?if(isset($no)){echo '수정';}else{echo '등록';}?></button>
		...
		<div class="modal fade" id="Modal_order" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">발주서를 선택해주세요.</h4>
					</div>
							...
							<div class="col-lg-12">
									<section id="no-more-tables">
										<table class="table table-bordered table-hover table-striped">
											...
											<?
											$sql = "select * from wine_order where order_cate = '발주' ORDER BY idx DESC";
											$conn->DBQ($sql);
											$conn->DBE();
											...
											<tbody>
												<tr>
													<td data-title="선택"><a href="purchase_form.php?aNo=<?echo $row['idx'];?>"><button type="submit" class="btn btn-primary btn-xs">선택</button></a></td>
													<td data-title="매입코드"><?echo $row['order_code'];?></td>
