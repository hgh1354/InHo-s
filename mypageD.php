      ...
      <section class="wrapper site-min-height">
        <div class="row mt">
          ...
          <!-- /col-lg-12 -->
					...
					<?
					$sql = "select * from Account_member where id = '".$_SESSION['id']."'";
					$conn->DBQ($sql);
					$conn->DBE();
					$row = $conn->DBF();
				...
				<div class="row mt">
					<form action="./api/basicReg/mypageD.php" method="post" name="mypageD">
								...
								<div class="form-panel">
									<div class="cmxform form-horizontal style-form">
										...
										<div class="form-group">
											<label for="date" class="control-label col-lg-2"><font color="red">비밀번호</font></label>
											<div class="col-lg-10">
												<input type="password" class="form-control" id="id" name="pass"  value="">
											</div>
										</div>
		...
		<div class="row mt" style="text-align:right">
			<div class="col-lg-12">
				<button type="submit" class="btn btn-primary submit mb-1">탈퇴하기</button>
			</div>
		</div>
