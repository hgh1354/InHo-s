    ...
    <body>
        ...
        <?php
            if (isset($_POST['submit']) )
            {
              ...
              if (!empty($keyword))
              {
                $apikey = 'AIzaSyA_BqySomdiFiDXTw76-2ZMO30AcPFP8tw'; 
...
<!--    
                        ...
                        <div  class="videoDiv">
                            <iframe id="iframe" style="width:100%;height:100%" src="http://www.youtube.com/embed/<?php echo $videoId; ?>" 
                                    data-autoplay-src="http://www.youtube.com/embed/<?php echo $videoId; ?>?rel=0&autoplay=1" allowfullscreen></iframe>                     
                        </div>
                        <div class="videoInfo">
