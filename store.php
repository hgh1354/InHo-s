  ...
  <section id="container">
    ...
    <section id="main-content" style="min-height:800px;">
	  <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i><a href="<?=$_SERVER['PHP_SELF']?>">매장 관리</a></h3>
		<div class="row mt">
		      ...
		      <div class="input-group">
			    <div class="input-group-btn search-panel">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="#ware_code">매장코드</a></li>
                    <li><a href="#ware_name">매장명</a></li>
                    <li><a href="#ware_m">대표자명</a></li>
                  </ul>
                </div>
                ...
                <tbody>
				  <?if($result!= 0){while($row = $conn->DBF()){?>
                    <tr>
                      ...
                      <td data-title="매장코드"><a href="store_form.php?no=<?echo $row ['idx'];?>">
					  <?echo $row['store_code'];?></a></td>
                      <td data-title="매장명"><a href="store_form.php?no=<?echo $row ['idx'];?>">
					  <?echo $row['store_name'];?></a></td>
                      <td class="numeric" data-title="대표자명"><?echo $row['store_m'];?></td>
                      <td class="numeric" data-title="전화번호"><?echo $row['store_call'];?></td>
                      <td class="numeric" data-title="핸드폰번호"><?echo $row['store_phone'];?></td>
                      <td class="numeric" data-title="이메일"><?echo $row['store_mail'];?></td>
                    </tr>
				<?}
				}else{$empty = "결과가 없습니다."?>
				<?}?>
		...
		<div class="row" style="text-align:right">
          <div class="col-lg-12" style="">
		    <button type="button" class="btn btn-default" onclick="location.href='store_form.php'">신규</button>
