  ...
  <section id="container">
    ...
    <section id="main-content" style="min-height:800px;">
  	  <section class="wrapper">
				<h3><a href="stockInputNew.php"><i class="fa fa-angle-right"></i>입고 추가</a></h3>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="" class="input-append date dpYears">
												...
												<input type="text" id="datepicker" name="date_from" readonly="readonly" placeholder="물품이 입고되는 날짜를 선택해주세요." value="<?php echo $cur_date; ?>" class="form-control" required="">
											</div>
										</div>
								</div>
				...
				<div class="col-lg-6">
					<div class="form-panel">
						<div class="cmxform form-horizontal style-form">
							...
							<div class="form-group">
								<div class="fa-hover col-md-2 col-sm-3">
									<a href="#" data-toggle="modal" data-target="#myModal_deposit"><i class="fa fa-search" name= "deposit_name"></i> 입고 창고 </a>
							...
							<div class="col-lg-10">
								<input class="form-control" id="cwarehouse" type="text" name="warehouse" placeholder="재고가 입고될 창고를 선택해주세요.">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input class="form-control" id="cwarehouse" type="text" name="store" placeholder="재고가 소속될 매장을 선택해주세요.">
							</div>
					</div>
							...
							<thead class="cf" style="background-color: #BDBDBD;">
								...
								<tbody>
									<tr id="myTr[0]">
										...
										<td data-title="단가"><input type="number" class="form-control" autocomplete="off" id="in_out_price[0]" name="in_out_price[]" value=""></td>
										<td data-title="입고 수량"><input type="number" class="form-control" autocomplete="off" id="in_out_cnt[0]" name="in_out_cnt[]" value=""></td>
									</tr>
								</tbody>
							</table>
						</section>
							...
							<div class="col-lg-12">
									<section id="no-more-tables">
										<table class="table table-bordered table-hover table-striped">
											...
											<?
											$sql = "select * from wine_in_out where in_out_cate = '매입'";
											$conn->DBQ($sql);
											$conn->DBE();
  ...
  <?$layout->js($js);?>
	...
	<script>
		...
		$("#addItemBtn").click(function() {
			...
			rowItem += '<td data-title="입고 수량"><input type="number" class="form-control" autocomplete="off" id="in_out_cnt['+i+']" name="in_out_cnt[]" value=""></td>'
