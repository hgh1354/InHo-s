  ...
  <section id="container">
    ...
    <section id="main-content" style="min-height:800px;">
	  <section class="wrapper">
        <h3><a href="order_form.php"><i class="fa fa-angle-right"></i><?if(isset($no)){echo '주문 상세';}else{echo '주문 등록';}?></a></h3>
            ...
            <div class="form-panel">
			  <div class="cmxform form-horizontal style-form">
				...
				<div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="com_name" name="com_name" minlength="2" type="text" readonly <?if(isset($no)){echo 'value='.$result['com_name'];}?><?if(isset($com_idx)){echo 'value='.$res_com['com_name'];}?> required >
                    </div>
				</div>
				...
				<div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="m_name" name="m_name" minlength="2" readonly <?if(isset($no)){echo 'value='.$result['m_name'];}?> type="text" required >
                    </div>
				</div>
            ...
            <div class="form-panel">
			  <div class="cmxform form-horizontal style-form">
				...
				<div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="store_name" name="store_name" minlength="2" readonly <?if(isset($no)){echo 'value='.$result['store_name'];}?> type="text">
                    </div>
				</div>
