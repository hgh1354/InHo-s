  ...
  <section id="container">
    ...
    <section id="main-content" style="min-height:800px;">
	  <section class="wrapper">
        <h3><a href="spendNew.php"><i class="fa fa-angle-right"></i>입금 추가</a></h3>
						...
						<table class="table table-bordered table-hover table-striped" id="order_table">
						  ...
						  <tbody id="tbody">
								<tr id="myTr[0]">
									...
									<td data-title="수입 내용"><input type="text" class="form-control" id="product_name[0]" name="product_name[]" value="" required=""></td>
									<td data-title="금액"><input type="text" class="form-control" id="all_price[0]" autocomplete="off" name="all_price[]" required="" value="" onchange="getNumber(this);" onkeyup="getNumber(this);" ></td>
								</tr>
						  </tbody>
						</table>
				  </section>
  ...
  <?$layout->js($js);?>
	...
	<script>
		...
		$('#addItemBtn').click(function() {
			...
			rowItem += '<td data-title="금액"> <input type="text" class="form-control" autocomplete="off" id="all_price['+i+']" name="all_price[]" required="" value="" onchange="getNumber(this);" onkeyup="getNumber(this);" ></td>';
