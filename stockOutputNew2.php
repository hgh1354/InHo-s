...
<body>
  <section id="container">
    ...
    <section id="main-content" style="min-height:800px;">
      ...
      <h3><a href="stockInputNew2.php?bNo=<<?php echo $_GET['bNo'];?>"><i class="fa fa-angle-right"></i> 출고 추가</a></h3>
	        ...
	        <!-- /col-lg-6 END -->
								...
								<table class="table table-bordered table-hover table-striped" id="order_table">
									...
									<tbody>
										...
										<tr>
											...
											<td data-title="단가">
												<input type="number" class="form-control" autocomplete="off" id="in_out_price[<?php echo $i; ?>]" name="in_out_price[]" required="" readonly="" <?echo 'value='.$res['sup_price'];?>>
											</td>
											<td data-title="수량">
												<input type="text" class="form-control" autocomplete="off" id="in_out_cnt[<?php echo $i; ?>]" required="" readonly="" value="<?php echo $res['in_out_cnt'];?>">
											</td>
										</tr>
										<?php $i++;} ?>
									</tbody>
		        ...
		        <div class="form-panel">
		              ...
		              <div class="control-label col-lg-2">
				          ...
				          <div class="col-lg-10">
				            <input class=" form-control" id="manager" placeholder="출고건에 대한 담당자를 입력해주세요. . ." name="manager" minlength="2" type="text" value="" required="">
				          </div>
								</div>
							...
							<table class="table table-bordered table-hover table-striped" id="order_table">
								...
								<tbody>
									...
									<tr>
										...
										<td data-title="수량">
											<input type="text" class="form-control" id="in_out_cnt[<?php echo $i; ?>]" name="in_out_cnt[]" required="" readonly="" value="<?php echo $res['in_out_cnt'];?>">
										</td>
										<td data-title="출고 수량">
											<input type="number" class="form-control" id="done_cnt[<?php echo $i; ?>]" name="done_cnt[]" required="" value="">
										</td>
									</tr>
									<?php $i++;} ?>
								</tbody>
                    ...
                    <div class="col-lg-12">
                        <section id="no-more-tables">
                          <table class="table table-bordered table-hover table-striped">
                            ...
                            <?
                            $sql = "select * from wine_in_out where in_out_cate = '매출' and stock_cur = '0'";
                            $conn->DBQ($sql);
                            $conn->DBE();
