...
//매장 폼
	...
	if(isset($_REQUEST['no']) && $_REQUEST['no'] != null) {
		...
		$conn->DBI(); //DB 접속
		$query = "SELECT * FROM wine_store WHERE idx = $no";
...
<body>
  <section id="container">
    ...
    <section id="main-content" style="min-height:700px;">
	  ...
	  <form action="./api/basicReg/companyI.php" method="post" name="store_form"><!--여기 링크 설정-->
		<input class="form-control" name="type" type="hidden" value="store">
        <?if(isset($no)){?>
	    <input class=" form-control" name="no" type="hidden" value="<?echo $result['idx']?>">
		<?}?>
        <h3><i class="fa fa-angle-right"></i><?if(isset($no)){echo '매장 상세보기';}else{echo '매장 등록';}?></h3>	 		
		<div class="row mt">	 
            ...
            <div class="form-panel">
			  <div class="cmxform form-horizontal style-form">
				<div class="form-group">
                    <label for="num" class="control-label col-lg-2"><font color="red">매장코드</font></label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="num" name="num" minlength="2" type="text" required <?if(isset($no)){echo 'value='.$result['store_code'];}?>>
                    </div>
				</div>
				
				<div class="form-group ">
                    <label for="name" class="control-label col-lg-2"><font color="red">매장명</font></label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="name" name="name" minlength="2" type="text" required 
					  <?if(isset($no)){echo 'value='.$result['store_name'];}?>>
                    </div>
				</div>
				...
				<div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="mname" name="mname" minlength="2" type="text" required <?if(isset($no)){echo 'value='.$result['store_m'];}?>>
                    </div>
				</div>
<?
if(isset($no)){
	$phone = $result['store_phone'];
...
?>				
				...
				<div class="form-group">
                    ...
                    <div class="col-lg-10">
					  ...
					  <?if(isset($no)){echo 'value='.$result['store_mail'];}?>>
                    </div>
				</div>
			  </div>
			</div>
			  ...
			  <div class="cmxform form-horizontal style-form">
				<div class="form-group ">
                    ...
                    <div class="col-lg-10">
					  ...
					  <?if(isset($no)){echo 'value='.$result['store_address'];}?>>
                    </div>
				</div>
				...
				<div class="form-group ">
                    ...
                    <div class="col-lg-10">
					  ...
					  <?if(isset($no)){echo 'value='.$result['store_call'];}?>>
                    </div>
				</div>
				...
				<div class="form-group ">
                    ...
                    <div class="col-lg-10">
					  ...
					  <?if(isset($no)){echo 'value='.$result['store_fax'];}?>>
                    </div>
				</div>
