...
<body>
  <section id="container">
    ...
    <section id="main-content" style="min-height:800px;">
      ...
      <h3><a href="stockInputD.php?sNo=<?php echo $_GET['sNo'];?>"><i class="fa fa-angle-right"></i> 입고 상세</a></h3>
			<form action="./api/stockReg/stock_modify_ok.php" class="form-horizontal style-form" method="post"> <!--  name="order_form" id="order_form" -->
				<input type="hidden" name="compare" value="입고">
	        ...
	        <!-- /col-lg-6 END -->
		          ...
		          <!-- /col-lg-6 END -->
                        ...
                        <td data-title="입고 수량">
													<?if($_GET['iNo'] != null) {?>
                          <input type="number" class="form-control" autocomplete="off" id="done_cnt[<?php echo $i; ?>]" name="done_cnt[]" required="" placeholder="입고된 수량 : <?php echo $res['done_cnt']; ?>" value="">
													<?} if($_GET['iNo'] == null) {?>
