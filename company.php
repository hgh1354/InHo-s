  ...
  <section id="container">
    ...
    <section id="main-content" style="min-height:800px;">
	  <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i><a href="<?=$_SERVER['PHP_SELF']?>">거래처 관리</a></h3>
		<div class="row mt">
		      ...
		      <div class="input-group">
			    <div class="input-group-btn search-panel">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="#com_name">상호명</a></li>
                    <li><a href="#com_m">대표자명</a></li>
					<li><a href="#com_address">지역</a></li>
                  </ul>
                </div>
                ...
                <tbody>
				  <?if($result!= 0){while($row = $conn->DBF()){?>
                    <tr>
                      ...
                      <td data-title="사업자번호"><a href="company_form.php?no=<?echo $row ['idx'];?>">
					  <?echo $row['com_code'];?></a></td>
                      <td data-title="거래처명"><a href="company_form.php?no=<?echo $row ['idx'];?>">
					  <?echo $row['com_name'];?></a></td>
		...
		<div class="row" style="text-align:right">
          <div class="col-lg-12" style="">
		    <button type="button" class="btn btn-default" onclick="location.href='company_form.php'">신규</button>
