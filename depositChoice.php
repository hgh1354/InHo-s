    							...
    							<div class="col-lg-12">
    									<section id="no-more-tables">
    										<table class="table table-bordered table-hover table-striped">
    											...
    											<tbody>
    												<tr>
    													<td data-title="선택"><a href="depositNew2.php?aNo=<?echo $row['idx'];?>"><button type="submit" class="btn btn-primary btn-xs"><i class="fa fa-check"></i></button></a></td>
